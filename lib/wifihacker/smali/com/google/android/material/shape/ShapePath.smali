...
.method private addConnectingShadowIfNecessary(F)V
    ...
    invoke-direct {v0, v2, v3, v4, v5}, Lcom/google/android/material/shape/ShapePath$PathArcOperation;-><init>(FFFF)V

    .line 304
    .local v0, "pathArcOperation":Lcom/google/android/material/shape/ShapePath$PathArcOperation;
    invoke-direct {p0}, Lcom/google/android/material/shape/ShapePath;->getCurrentShadowAngle()F

    move-result v2

    invoke-static {v0, v2}, Lcom/google/android/material/shape/ShapePath$PathArcOperation;->access$600(Lcom/google/android/material/shape/ShapePath$PathArcOperation;F)V

    .line 305
    invoke-static {v0, v1}, Lcom/google/android/material/shape/ShapePath$PathArcOperation;->access$700(Lcom/google/android/material/shape/ShapePath$PathArcOperation;F)V
    ...
    invoke-direct {v3, v0}, Lcom/google/android/material/shape/ShapePath$ArcShadowOperation;-><init>(Lcom/google/android/material/shape/ShapePath$PathArcOperation;)V
...
.method public addArc(FFFFFF)V
    ...
    invoke-direct {v3, p1, p2, p3, p4}, Lcom/google/android/material/shape/ShapePath$PathArcOperation;-><init>(FFFF)V

    .line 212
    .local v3, "operation":Lcom/google/android/material/shape/ShapePath$PathArcOperation;
    invoke-static {v3, p5}, Lcom/google/android/material/shape/ShapePath$PathArcOperation;->access$600(Lcom/google/android/material/shape/ShapePath$PathArcOperation;F)V

    .line 213
    invoke-static {v3, p6}, Lcom/google/android/material/shape/ShapePath$PathArcOperation;->access$700(Lcom/google/android/material/shape/ShapePath$PathArcOperation;F)V

    .line 214
    iget-object v4, p0, Lcom/google/android/material/shape/ShapePath;->operations:Ljava/util/List;
    ...
    invoke-direct {v0, v3}, Lcom/google/android/material/shape/ShapePath$ArcShadowOperation;-><init>(Lcom/google/android/material/shape/ShapePath$PathArcOperation;)V

    .line 217
    .local v0, "arcShadowOperation":Lcom/google/android/material/shape/ShapePath$ArcShadowOperation;
    add-float v2, p5, p6
    ...
    .line 222
    .local v1, "drawShadowInsideBounds":Z
    :goto_0
    if-eqz v1, :cond_2
    ...
    :cond_0
    invoke-direct {p0, v0, v4, v2}, Lcom/google/android/material/shape/ShapePath;->addShadowCompatOperation(Lcom/google/android/material/shape/ShapePath$ShadowCompatOperation;FF)V
    ...
    .line 221
    .end local v1    # "drawShadowInsideBounds":Z
    .restart local v2    # "endAngle":F
    :cond_1
    const/4 v1, 0x0

    goto :goto_0

    .restart local v1    # "drawShadowInsideBounds":Z
    :cond_2
    move v4, p5
...
.method createShadowCompatOperation(Landroid/graphics/Matrix;)Lcom/google/android/material/shape/ShapePath$ShadowCompatOperation;
    ...
    invoke-direct {p0, v2}, Lcom/google/android/material/shape/ShapePath;->addConnectingShadowIfNecessary(F)V
    ...
    .line 257
    .local v1, "transformCopy":Landroid/graphics/Matrix;
    new-instance v0, Ljava/util/ArrayList;
    ...
    invoke-direct {v2, p0, v0, v1}, Lcom/google/android/material/shape/ShapePath$1;-><init>(Lcom/google/android/material/shape/ShapePath;Ljava/util/List;Landroid/graphics/Matrix;)V
...
.method public lineTo(FF)V
    ...
    .line 138
    invoke-direct {p0, v1, v2, v3}, Lcom/google/android/material/shape/ShapePath;->addShadowCompatOperation(Lcom/google/android/material/shape/ShapePath$ShadowCompatOperation;FF)V
