...
.method public static createWithElevationOverlay(Landroid/content/Context;F)Lcom/google/android/material/shape/MaterialShapeDrawable;
    ...
    const-class v3, Lcom/google/android/material/shape/MaterialShapeDrawable;
    ...
    .line 171
    invoke-static {p0, v2, v3}, Lcom/google/android/material/color/MaterialColors;->getColor(Landroid/content/Context;ILjava/lang/String;)I
...
.method private drawCompatShadow(Landroid/graphics/Canvas;)V
    ...
    .prologue
    .line 1087
    iget-object v3, p0, Lcom/google/android/material/shape/MaterialShapeDrawable;->containsIncompatibleShadowOp:Ljava/util/BitSet;
    ...
    .line 1088
    sget-object v3, Lcom/google/android/material/shape/MaterialShapeDrawable;->TAG:Ljava/lang/String;

    const-string v4, "Compatibility shadow requested but can\'t be drawn for all operations in this shape."
    ...
    iget-object v4, p0, Lcom/google/android/material/shape/MaterialShapeDrawable;->shadowRenderer:Lcom/google/android/material/shadow/ShadowRenderer;

    invoke-virtual {v4}, Lcom/google/android/material/shadow/ShadowRenderer;->getShadowPaint()Landroid/graphics/Paint;
    ...
    invoke-virtual {v3, v4, v5, p1}, Lcom/google/android/material/shape/ShapePath$ShadowCompatOperation;->draw(Lcom/google/android/material/shadow/ShadowRenderer;ILandroid/graphics/Canvas;)V
    ...
    .line 1111
    .end local v1    # "shadowOffsetX":I
    .end local v2    # "shadowOffsetY":I
    :cond_3
    return-void
.end method
...
.method private drawShape(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/Path;Lcom/google/android/material/shape/ShapeAppearanceModel;Landroid/graphics/RectF;)V
    ...
    invoke-interface {v1, p5}, Lcom/google/android/material/shape/CornerSize;->getCornerSize(Landroid/graphics/RectF;)F
...
.method private maybeDrawCompatShadow(Landroid/graphics/Canvas;)V
    ...
    .line 977
    iget-boolean v6, p0, Lcom/google/android/material/shape/MaterialShapeDrawable;->shadowBitmapDrawingEnable:Z
    ...
    const-string v7, "Invalid shadow bounds. Check that the treatments result in a valid path."
    ...
    .line 1000
    .local v3, "shadowLayer":Landroid/graphics/Bitmap;
    ...
    .line 1007
    invoke-direct {p0, v2}, Lcom/google/android/material/shape/MaterialShapeDrawable;->drawCompatShadow(Landroid/graphics/Canvas;)V
...
.method private prepareCanvasForShadow(Landroid/graphics/Canvas;)V
    ...
    .line 1076
    .end local v0    # "canvasClipBounds":Landroid/graphics/Rect;
    :cond_0
    int-to-float v3, v1
...
.method private updateColorsForState([I)Z
    ...
    .end local v3    # "previousFillColor":I
    :cond_0
    iget-object v5, p0, Lcom/google/android/material/shape/MaterialShapeDrawable;->drawableState:Lcom/google/android/material/shape/MaterialShapeDrawable$MaterialShapeDrawableState;

    iget-object v5, v5, Lcom/google/android/material/shape/MaterialShapeDrawable$MaterialShapeDrawableState;->strokeColor:Landroid/content/res/ColorStateList;
    ...
    .line 1307
    .local v4, "previousStrokeColor":I
    iget-object v5, p0, Lcom/google/android/material/shape/MaterialShapeDrawable;->drawableState:Lcom/google/android/material/shape/MaterialShapeDrawable$MaterialShapeDrawableState;
    ...
    .end local v4    # "previousStrokeColor":I
    :cond_1
    return v0
.end method
...
.method private updateTintFilter()Z
    ...
    .line 1216
    .local v1, "originalTintFilter":Landroid/graphics/PorterDuffColorFilter;
    ...
    .line 1217
    .local v0, "originalStrokeTintFilter":Landroid/graphics/PorterDuffColorFilter;
    iget-object v4, p0, Lcom/google/android/material/shape/MaterialShapeDrawable;->drawableState:Lcom/google/android/material/shape/MaterialShapeDrawable$MaterialShapeDrawableState;

    iget-object v4, v4, Lcom/google/android/material/shape/MaterialShapeDrawable$MaterialShapeDrawableState;->tintList:Landroid/content/res/ColorStateList;

    iget-object v5, p0, Lcom/google/android/material/shape/MaterialShapeDrawable;->drawableState:Lcom/google/android/material/shape/MaterialShapeDrawable$MaterialShapeDrawableState;

    iget-object v5, v5, Lcom/google/android/material/shape/MaterialShapeDrawable$MaterialShapeDrawableState;->tintMode:Landroid/graphics/PorterDuff$Mode;

    iget-object v6, p0, Lcom/google/android/material/shape/MaterialShapeDrawable;->fillPaint:Landroid/graphics/Paint;

    .line 1218
    invoke-direct {p0, v4, v5, v6, v3}, Lcom/google/android/material/shape/MaterialShapeDrawable;->calculateTintFilter(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Landroid/graphics/Paint;Z)Landroid/graphics/PorterDuffColorFilter;
    ...
    iget-object v4, v4, Lcom/google/android/material/shape/MaterialShapeDrawable$MaterialShapeDrawableState;->strokeTintList:Landroid/content/res/ColorStateList;

    iget-object v5, p0, Lcom/google/android/material/shape/MaterialShapeDrawable;->drawableState:Lcom/google/android/material/shape/MaterialShapeDrawable$MaterialShapeDrawableState;

    iget-object v5, v5, Lcom/google/android/material/shape/MaterialShapeDrawable$MaterialShapeDrawableState;->tintMode:Landroid/graphics/PorterDuff$Mode;

    iget-object v6, p0, Lcom/google/android/material/shape/MaterialShapeDrawable;->strokePaint:Landroid/graphics/Paint;

    .line 1224
    invoke-direct {p0, v4, v5, v6, v2}, Lcom/google/android/material/shape/MaterialShapeDrawable;->calculateTintFilter(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Landroid/graphics/Paint;Z)Landroid/graphics/PorterDuffColorFilter;
    ...
    iget-boolean v4, v4, Lcom/google/android/material/shape/MaterialShapeDrawable$MaterialShapeDrawableState;->useTintColorForShadow:Z
    ...
    iget-object v5, v5, Lcom/google/android/material/shape/MaterialShapeDrawable$MaterialShapeDrawableState;->tintList:Landroid/content/res/ColorStateList;
    ...
    .line 1230
    invoke-virtual {v4, v5}, Lcom/google/android/material/shadow/ShadowRenderer;->setShadowColor(I)V

    .line 1233
    :cond_0
    iget-object v4, p0, Lcom/google/android/material/shape/MaterialShapeDrawable;->tintFilter:Landroid/graphics/PorterDuffColorFilter;

    invoke-static {v1, v4}, Landroidx/core/util/ObjectsCompat;->equals(Ljava/lang/Object;Ljava/lang/Object;)Z

    move-result v4

    if-eqz v4, :cond_1

    iget-object v4, p0, Lcom/google/android/material/shape/MaterialShapeDrawable;->strokeTintFilter:Landroid/graphics/PorterDuffColorFilter;

    .line 1234
    invoke-static {v0, v4}, Landroidx/core/util/ObjectsCompat;->equals(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v3, p0, Lcom/google/android/material/shape/MaterialShapeDrawable;->tintFilter:Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-static {v0, v3}, Lcom/google/android/material/shape/MaterialShapeDrawable;->modulateAlpha(II)I
...
.method public getShapedViewModel()Lcom/google/android/material/shape/ShapePathModel;
    ...
    .end local v0    # "shapeAppearance":Lcom/google/android/material/shape/ShapeAppearanceModel;
    :goto_0
    return-object v0

    .restart local v0    # "shapeAppearance":Lcom/google/android/material/shape/ShapeAppearanceModel;
    :cond_0
    const/4 v0, 0x0
...
.method protected onStateChange([I)Z
    ...
    .line 1285
    .local v1, "paintColorChanged":Z
    invoke-direct {p0}, Lcom/google/android/material/shape/MaterialShapeDrawable;->updateTintFilter()Z

    move-result v2

    .line 1286
    .local v2, "tintFilterChanged":Z
    if-nez v1, :cond_0
