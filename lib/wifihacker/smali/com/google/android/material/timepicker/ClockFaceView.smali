...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v6, p0, Lcom/google/android/material/timepicker/ClockFaceView;->textViewRect:Landroid/graphics/Rect;
    ...
    iput-object v6, p0, Lcom/google/android/material/timepicker/ClockFaceView;->scratch:Landroid/graphics/RectF;
    ...
    iput-object v6, p0, Lcom/google/android/material/timepicker/ClockFaceView;->textViewPool:Landroid/util/SparseArray;
    ...
    iput-object v6, p0, Lcom/google/android/material/timepicker/ClockFaceView;->gradientPositions:[F

    .line 99
    sget-object v6, Lcom/google/android/material/R$styleable;->ClockFaceView:[I

    sget v7, Lcom/google/android/material/R$style;->Widget_MaterialComponents_TimePicker_Clock:I
    ...
    sget v6, Lcom/google/android/material/R$styleable;->ClockFaceView_clockNumberTextColor:I

    .line 107
    invoke-static {p1, v0, v6}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v6

    iput-object v6, p0, Lcom/google/android/material/timepicker/ClockFaceView;->textColor:Landroid/content/res/ColorStateList;
    ...
    sget v7, Lcom/google/android/material/R$layout;->material_clockface_view:I

    invoke-virtual {v6, v7, p0, v9}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;

    .line 110
    sget v6, Lcom/google/android/material/R$id;->material_clock_hand:I

    invoke-virtual {p0, v6}, Lcom/google/android/material/timepicker/ClockFaceView;->findViewById(I)Landroid/view/View;

    move-result-object v6

    check-cast v6, Lcom/google/android/material/timepicker/ClockHandView;

    iput-object v6, p0, Lcom/google/android/material/timepicker/ClockFaceView;->clockHandView:Lcom/google/android/material/timepicker/ClockHandView;
    ...
    iput-object v6, p0, Lcom/google/android/material/timepicker/ClockFaceView;->gradientColors:[I

    .line 117
    iget-object v6, p0, Lcom/google/android/material/timepicker/ClockFaceView;->clockHandView:Lcom/google/android/material/timepicker/ClockHandView;

    invoke-virtual {v6, p0}, Lcom/google/android/material/timepicker/ClockHandView;->addOnRotateListener(Lcom/google/android/material/timepicker/ClockHandView$OnRotateListener;)V

    .line 119
    sget v6, Lcom/google/android/material/R$color;->material_timepicker_clockface:I
    ...
    sget v6, Lcom/google/android/material/R$styleable;->ClockFaceView_clockFaceBackgroundColor:I
    ...
    .end local v3    # "defaultBackgroundColor":I
    :goto_0
    ...
    .line 146
    invoke-virtual {p0, v9}, Lcom/google/android/material/timepicker/ClockFaceView;->setFocusable(Z)V
    ...
    .line 173
    invoke-virtual {p0, v4, v10}, Lcom/google/android/material/timepicker/ClockFaceView;->setValues([Ljava/lang/String;I)V
    ...
    .line 128
    .end local v4    # "initialValues":[Ljava/lang/String;
    .restart local v3    # "defaultBackgroundColor":I
    :cond_0
...
.method private findIntersectingTextView()V
    ...
    .prologue
    .line 251
    iget-object v4, p0, Lcom/google/android/material/timepicker/ClockFaceView;->clockHandView:Lcom/google/android/material/timepicker/ClockHandView;

    invoke-virtual {v4}, Lcom/google/android/material/timepicker/ClockHandView;->getCurrentSelectorBox()Landroid/graphics/RectF;

    move-result-object v2

    .line 252
    .local v2, "selectorBox":Landroid/graphics/RectF;
    const/4 v0, 0x0
    ...
    invoke-virtual {p0, v3, v4}, Lcom/google/android/material/timepicker/ClockFaceView;->offsetDescendantRectToMyCoords(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-direct {p0, v2, v4}, Lcom/google/android/material/timepicker/ClockFaceView;->getGradientForTextView(Landroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RadialGradient;

    move-result-object v1

    .line 263
    .local v1, "radialGradient":Landroid/graphics/RadialGradient;
    invoke-virtual {v3}, Landroid/widget/TextView;->getPaint()Landroid/text/TextPaint;

    move-result-object v4

    invoke-virtual {v4, v1}, Landroid/text/TextPaint;->setShader(Landroid/graphics/Shader;)Landroid/graphics/Shader;
    ...
    .line 266
    .end local v1    # "radialGradient":Landroid/graphics/RadialGradient;
...
.method protected onMeasure(II)V
    ...
    .line 300
    .local v5, "width":F
    iget v6, p0, Lcom/google/android/material/timepicker/ClockFaceView;->clockSize:I

    int-to-float v6, v6

    iget v7, p0, Lcom/google/android/material/timepicker/ClockFaceView;->minimumHeight:I

    int-to-float v7, v7

    div-float/2addr v7, v1

    iget v8, p0, Lcom/google/android/material/timepicker/ClockFaceView;->minimumWidth:I
    ...
    invoke-static {v7, v8, v9}, Lcom/google/android/material/timepicker/ClockFaceView;->max3(FFF)F
    ...
    .line 303
    .local v4, "spec":I
    invoke-virtual {p0, v3, v3}, Lcom/google/android/material/timepicker/ClockFaceView;->setMeasuredDimension(II)V

    .line 304
    invoke-super {p0, v4, v4}, Lcom/google/android/material/timepicker/RadialViewGroup;->onMeasure(II)V
