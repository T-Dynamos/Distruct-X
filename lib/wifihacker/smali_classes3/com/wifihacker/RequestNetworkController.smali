.class public Lcom/wifihacker/RequestNetworkController;
...
.field private static mInstance:Lcom/wifihacker/RequestNetworkController;
...
.method private getClient()Lokhttp3/OkHttpClient;
    ...
    .prologue
    .line 54
    iget-object v0, p0, Lcom/wifihacker/RequestNetworkController;->client:Lokhttp3/OkHttpClient;
    ...
    .line 59
    new-instance v3, Lcom/wifihacker/RequestNetworkController$1;

    invoke-direct {v3, p0}, Lcom/wifihacker/RequestNetworkController$1;-><init>(Lcom/wifihacker/RequestNetworkController;)V
    ...
    .line 84
    new-instance v0, Lcom/wifihacker/RequestNetworkController$2;

    invoke-direct {v0, p0}, Lcom/wifihacker/RequestNetworkController$2;-><init>(Lcom/wifihacker/RequestNetworkController;)V
    ...
    iput-object v0, p0, Lcom/wifihacker/RequestNetworkController;->client:Lokhttp3/OkHttpClient;
...
.method public static declared-synchronized getInstance()Lcom/wifihacker/RequestNetworkController;
    .locals 2

    .prologue
    .line 47
    const-class v1, Lcom/wifihacker/RequestNetworkController;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/wifihacker/RequestNetworkController;->mInstance:Lcom/wifihacker/RequestNetworkController;

    if-nez v0, :cond_0

    .line 48
    new-instance v0, Lcom/wifihacker/RequestNetworkController;

    invoke-direct {v0}, Lcom/wifihacker/RequestNetworkController;-><init>()V

    sput-object v0, Lcom/wifihacker/RequestNetworkController;->mInstance:Lcom/wifihacker/RequestNetworkController;
...
# virtual methods
.method public execute(Lcom/wifihacker/RequestNetwork;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/wifihacker/RequestNetwork$RequestListener;)V
    .locals 6
    ...
    .line 103
    invoke-virtual {p1}, Lcom/wifihacker/RequestNetwork;->getHeaders()Ljava/util/HashMap;
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p1}, Lcom/wifihacker/RequestNetwork;->getRequestType()I
    ...
    .line 122
    :try_start_2
    invoke-virtual {p1}, Lcom/wifihacker/RequestNetwork;->getParams()Ljava/util/HashMap;
    ...
    .line 157
    invoke-direct {p0}, Lcom/wifihacker/RequestNetworkController;->getClient()Lokhttp3/OkHttpClient;
    ...
    new-instance v1, Lcom/wifihacker/RequestNetworkController$3;

    invoke-direct {v1, p0, p1, p5, p4}, Lcom/wifihacker/RequestNetworkController$3;-><init>(Lcom/wifihacker/RequestNetworkController;Lcom/wifihacker/RequestNetwork;Lcom/wifihacker/RequestNetwork$RequestListener;Ljava/lang/String;)V
    ...
    invoke-interface {p5, p4, v0}, Lcom/wifihacker/RequestNetwork$RequestListener;->onErrorResponse(Ljava/lang/String;Ljava/lang/String;)V
