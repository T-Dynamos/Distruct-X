...
.method private setUpEnterTransform(Landroid/view/Window;)V
    ...
    instance-of v2, v1, Lcom/google/android/material/transition/platform/MaterialContainerTransform;
    ...
    .line 234
    .local v0, "transform":Lcom/google/android/material/transition/platform/MaterialContainerTransform;
    ...
    invoke-virtual {v0, v2}, Lcom/google/android/material/transition/platform/MaterialContainerTransform;->addListener(Landroid/transition/Transition$TransitionListener;)Landroid/transition/Transition;

    .line 253
    .end local v0    # "transform":Lcom/google/android/material/transition/platform/MaterialContainerTransform;
    :cond_1
    return-void
.end method
...
.method private setUpReturnTransform(Landroid/app/Activity;Landroid/view/Window;)V
    ...
    invoke-virtual {v0, v2}, Lcom/google/android/material/transition/platform/MaterialContainerTransform;->setHoldAtEndEnabled(Z)V
...
.method public onCreateSnapshotView(Landroid/content/Context;Landroid/os/Parcelable;)Landroid/view/View;
    ...
    .line 96
    .local v2, "snapshotView":Landroid/view/View;
    if-eqz v2, :cond_0

    sget-object v3, Lcom/google/android/material/transition/platform/MaterialContainerTransformSharedElementCallback;->capturedSharedElement:Ljava/lang/ref/WeakReference;

    if-eqz v3, :cond_0

    iget-object v3, p0, Lcom/google/android/material/transition/platform/MaterialContainerTransformSharedElementCallback;->shapeProvider:Lcom/google/android/material/transition/platform/MaterialContainerTransformSharedElementCallback$ShapeProvider;
    ...
    invoke-interface {v3, v1}, Lcom/google/android/material/transition/platform/MaterialContainerTransformSharedElementCallback$ShapeProvider;->provideShape(Landroid/view/View;)Lcom/google/android/material/shape/ShapeAppearanceModel;
...
.method public onMapSharedElements(Ljava/util/List;Ljava/util/Map;)V
    ...
    .restart local v1    # "sharedElement":Landroid/view/View;
    .restart local v2    # "window":Landroid/view/Window;
    :cond_1
    invoke-direct {p0, v0, v2}, Lcom/google/android/material/transition/platform/MaterialContainerTransformSharedElementCallback;->setUpReturnTransform(Landroid/app/Activity;Landroid/view/Window;)V
